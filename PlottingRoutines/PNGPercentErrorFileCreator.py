...
#    for iAlt in AltitudeSlices:
    ...
    AnalyticalRho      = gdata['Analytical Bell'][:nLons,:nLats,iAlt]

    PError      = gdata['Percentage Error'][:nLons,:nLats,iAlt]
    #PError = 100.0*(Rho - AnalyticalRho)/AnalyticalRho
...
#        
    ...
    TitleString = 'Percent Difference      @  ' + DateString[iFile]
...
#        
    ...
    savefile = 'PercentErrorPNGFiles/image_'+FileString[iFile]+'.png'
    #fig.show()
